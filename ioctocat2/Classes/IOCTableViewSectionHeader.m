...
+ (instancetype)headerForTableView:(UITableView *)tableView title:(NSString *)title {
    ...
    NSMutableString *mStr =[NSMutableString stringWithString:title] ; //[ insertString:@"  " atIndex:0];
    [mStr insertString:@"    " atIndex:0];
	view.titleLabel.text = mStr;
	CGSize titleSize = [view.titleLabel.text sizeWithFont:view.titleLabel.font];
	view.titleLabel.frame = CGRectMake(20, 0, titleSize.width, view.frame.size.height);
...
//	[view.layer insertSublayer:gradient atIndex:0];
    ...
    //===egs  color plan
    view.backgroundColor = COLOR(88, 115, 112, 1);
//    view.titleLabel.center = CGPointMake(view.titleLabel.center.x+25, view.titleLabel.center.y);
    view.titleLabel.textColor = COLOR(246, 246, 246, 1);
